...
namespace AttaxxPlus.Model.Operations
{
    public class CloneMoveOperation : OperationBase
    {
        ...
        public override bool TryExecute(Field selectedField, Field currentField)
        {
            ...
            if ((Math.Abs(selectedField.Row - currentField.Row) + Math.Abs(selectedField.Column - currentField.Column) == 1) || Math.Abs(selectedField.Row - currentField.Row) == 1 && Math.Abs(selectedField.Column - currentField.Column) == 1
                && !selectedField.IsEmpty() && currentField.IsEmpty())
            {
